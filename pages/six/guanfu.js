...
function initMaterialPieChart() {
    ...
    // 辽宋金元官府建筑材料占比数据
    let data = [
        { value: 68, name: '木材（大木 + 小木）' },
        { value: 14, name: '瓦件（筒瓦、板瓦、脊兽、琉璃）' },
        { value: 9, name: '砖（墙体、台壁、铺地）' },
        { value: 6, name: '石材（柱础、台基、阶条、须弥座）' },
        { value: 2, name: '灰泥、麻刀、填料' },
        { value: 1, name: '金属件（钉、锔、箍、环、铁件）' }
    ];
...
function initStructureCharts(type) {
    ...
    const pieOption = {
        title: {
            text: type === 'hemudu' ? '抬梁式木架构组成' : '穿斗式木架构组成',
            left: 'right'
        },
        ...
        series: [
            {
                ...
                // 辽宋金元时期官府功能数据（贴合文本描述）
                data: [
                    { value: 27, name: '行政治事（正堂、签押房、办公厅堂）' },
                    { value: 14, name: '礼仪仪式（仪门、戒石亭、拜厅、典礼空间）' },
                    { value: 16, name: '吏员办公（六房：吏户礼兵刑工、承发房等）' },
                    { value: 12, name: '仓储物资（钱粮库、军资库、架阁库、档案库）' },
                    { value: 11, name: '司法狱政（听讼室、牢房、刑房相关）' },
                    { value: 20, name: '后勤服务（厨、庖、厩、马号、杂役房）' }
                ]
            }
        ]
    };
